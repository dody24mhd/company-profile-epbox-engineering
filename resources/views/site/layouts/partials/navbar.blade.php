...
<nav class="navbar fixed w-full z-50 py-3 sm:py-4 px-4 sm:px-6" id="navbar">
  <div class="max-w-7xl mx-auto flex justify-between items-center">
    ...
    <div class="flex items-center flex-shrink-0">
      <a href="{{ route('site.home') }}" class="inline-flex items-center">
        <img src="{{ asset('img/logo2.png') }}" alt="Epbox Engineering Pte. Ltd." class="h-10 sm:h-12 w-auto object-contain" loading="lazy">
      </a>
    </div>
    
    <!-- Desktop Menu -->
    <div class="desktop-menu hidden lg:flex space-x-1 xl:space-x-2">
      <a href="{{ route('site.home') }}" class="nav-link text-white {{ request()->routeIs('site.home') ? 'active' : '' }}">
      ...
      <a href="{{ route('blog.index') }}" class="nav-link text-white {{ request()->routeIs('blog*') ? 'active' : '' }}">
        <i class="fas fa-newspaper"></i><span class="nav-label">Blog</span>
      </a>
      <a href="{{ asset('e-catalog.pdf') }}" target="_blank" rel="noopener" class="nav-link text-white">
        <i class="fas fa-download"></i><span class="nav-label">E-Catalog</span>
      </a>
    ...
    <!-- Mobile Menu Button -->
    <button class="mobile-menu-btn lg:hidden text-white text-2xl" id="menu-toggle" aria-controls="mobile-menu" aria-expanded="false" aria-label="Toggle navigation">
  ...
  <div class="mobile-menu lg:hidden hidden" id="mobile-menu">
    <div class="mobile-menu-content">
      <a href="{{ route('site.home') }}" class="mobile-nav-link {{ request()->routeIs('site.home') ? 'active' : '' }}">
      ...
      <a href="{{ asset('e-catalog.pdf') }}" target="_blank" rel="noopener" class="mobile-nav-link">
        <i class="fas fa-download"></i>E-Catalog
      </a>

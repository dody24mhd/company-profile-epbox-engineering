...
@section('title', 'Local Control Panel (LCP) | Epbox Engineering')
@section('content')
    ...
    <div class="grid lg:grid-cols-2 gap-12 items-center">
      <div>
        ...
        <h1 class="text-4xl md:text-5xl font-bold mb-6"
          style="font-family: 'Roboto', sans-serif; font-weight: 900; letter-spacing: 0.5px;">Local Control Panel (LCP)</h1>
          ...
          <div class="bg-blue-900/20 rounded-lg p-6">
            <ul class="list-disc pl-6 space-y-3">
              <li class="text-white text-base md:text-lg">
                <span class="font-semibold text-gray-200" style="font-family: 'Roboto', sans-serif; letter-spacing: 0.3px;">Direct Field Control</span>
                <span class="text-gray-300">: Enables start/stop and equipment monitoring directly at site, ensuring fast operator response.</span>
              </li>
              <li class="text-white text-base md:text-lg">
                <span class="font-semibold text-gray-200" style="font-family: 'Roboto', sans-serif; letter-spacing: 0.3px;">Operator Safety</span>
                <span class="text-gray-300">: Built with emergency stop, lockable switches, and clear status indicators.</span>
              </li>
              <li class="text-white text-base md:text-lg">
                <span class="font-semibold text-gray-200" style="font-family: 'Roboto', sans-serif; letter-spacing: 0.3px;">Versatile Configurations</span>
                <span class="text-gray-300">: Available in standard or customized layouts to support pumps, fans, conveyors, and other field equipment.</span>
              </li>
              <li class="text-white text-base md:text-lg">
                <span class="font-semibold text-gray-200" style="font-family: 'Roboto', sans-serif; letter-spacing: 0.3px;">Rugged Enclosures</span>
                <span class="text-gray-300">: Designed for harsh environments with protection up to IP66 for outdoor or industrial use.</span>
              </li>
              <li class="text-white text-base md:text-lg">
                <span class="font-semibold text-gray-200" style="font-family: 'Roboto', sans-serif; letter-spacing: 0.3px;">System Integration</span>
                <span class="text-gray-300">: Compatible with SCADA, PLC, or central DCS systems for seamless plant-wide control.</span>
              </li>
            </ul>
          </div>
        </div>
              ...
              <tbody>
                <tr>
                  ...
                  <td class="w-2/3 text-white text-lg px-4 py-5 border border-white"
                    style="font-family: 'Roboto', sans-serif; font-weight: 500; letter-spacing: 0.3px;">110 – 690 V AC</td>
                </tr>
                <tr>
                  <th class="w-1/3 px-4 align-top text-white text-lg py-5 border border-white"
                ...
                <tr>
                  <th class="w-1/3 px-4 align-top text-white text-lg py-5 border border-white"
                    style="font-family: 'Roboto', sans-serif; font-weight: 500; letter-spacing: 0.3px;">Control Options</th>
                  <td class="w-2/3 text-white text-lg px-4 py-5 border border-white"
                    style="font-family: 'Roboto', sans-serif; font-weight: 500; letter-spacing: 0.3px;">Push buttons, selector switches, HMI, emergency stop</td>
                </tr>
                <tr>
                  <th class="w-1/3 px-4 align-top text-white text-lg py-5 border border-white"
                    style="font-family: 'Roboto', sans-serif; font-weight: 500; letter-spacing: 0.3px;">Materials</th>
                  <td class="w-2/3 text-white text-lg px-4 py-5 border border-white"
                    style="font-family: 'Roboto', sans-serif; font-weight: 500; letter-spacing: 0.3px;">Available in custom configurations</td>
                </tr>
                <tr>
                  <th class="w-1/3 px-4 align-top text-white text-lg py-5 border border-white"
                    style="font-family: 'Roboto', sans-serif; font-weight: 500; letter-spacing: 0.3px;">Integration</th>
                  <td class="w-2/3 text-white text-lg px-4 py-5 border border-white"
                    style="font-family: 'Roboto', sans-serif; font-weight: 500; letter-spacing: 0.3px;">PLC, SCADA, or DCS compatible</td>
                </tr>
                <tr>
                  <th class="w-1/3 px-4 align-top text-white text-lg py-5 border border-white"

...
<section class="blog-hero pt-24 sm:pt-32 pb-16 sm:pb-20 px-4 sm:px-6 gradient-bg relative overflow-hidden fade-section">
    ...
    <div class="max-w-7xl mx-auto relative z-10 text-center">
        <div class="mb-4">
            <a href="{{ route('site.blog') }}" class="inline-flex items-center gap-2 text-blue-300 hover:text-blue-200 transition-colors">
    ...
    <div class="max-w-4xl mx-auto relative z-10">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                <article class="bg-gradient-to-br from-blue-900/20 to-blue-800/10 border border-blue-500/20 rounded-xl overflow-hidden">
                    @if($blog->image_url)
                    ...
                    <div class="p-8">
                        ...
                        <div class="mt-8 pt-6 border-t border-blue-500/20">
                            <h4 class="text-lg font-semibold text-white mb-4">Tags</h4>
                            <div class="flex flex-wrap gap-2">
                                @foreach(explode(',', $blog->tags) as $tag)
                                <span class="bg-blue-600/20 text-blue-300 px-3 py-1 rounded-full text-sm border border-blue-500/30">
                                    {{ trim($tag) }}
                                </span>
                                @endforeach
                            </div>
            ...
            <div class="lg:col-span-1">
                ...
                <div class="bg-gradient-to-br from-blue-900/20 to-blue-800/10 border border-blue-500/20 rounded-xl p-6 mb-8">
                    <h3 class="text-xl font-bold text-white mb-6">Related Posts</h3>
                    <div class="space-y-4">
                        @foreach($relatedBlogs as $relatedBlog)
                        <div class="flex gap-4">
                            <div class="w-16 h-16 bg-gradient-to-br from-blue-600 to-blue-800 rounded-lg flex items-center justify-center flex-shrink-0">
                                @if($relatedBlog->image_url)
                                    <img src="{{ $relatedBlog->image_url }}" alt="{{ $relatedBlog->title }}" class="w-full h-full object-cover rounded-lg">
                                @else
                            ...
                            <div class="flex-1">
                                <h4 class="text-sm font-semibold text-white mb-1 line-clamp-2">
                                    <a href="{{ route('site.blog.show', $relatedBlog->id) }}" class="hover:text-blue-300 transition-colors">
                                        {{ $relatedBlog->title }}
                                    </a>
                                </h4>
                ...
                <!-- Back to News -->
                <div class="bg-gradient-to-br from-blue-900/20 to-blue-800/10 border border-blue-500/20 rounded-xl p-6">
                    <a href="{{ route('site.blog') }}" class="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-semibold transition duration-300 w-full justify-center">
                        <i class="fas fa-arrow-left"></i>

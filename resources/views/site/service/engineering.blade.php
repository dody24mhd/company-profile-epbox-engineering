...
<section class="pt-32 pb-20 px-6 gradient-bg relative overflow-hidden fade-section">
  <div class="max-w-7xl mx-auto relative z-10">
    <div class="grid lg:grid-cols-2 gap-12 items-center">
      ...
      <div class="relative">
        <img src="{{ asset('img/epbox2/gambar8.webp') }}" alt="Automation Integration" class="w-full h-80 object-cover rounded-lg shadow-2xl">
    ...
    <div class="grid lg:grid-cols-3 gap-12">
      ...
      <div class="space-y-8">
        <div class="bg-white backdrop-blur-sm p-6">
          <img src="{{ asset('img/epbox2/PLC.webp') }}" alt="PLC Image" class="plc-img w-full h-auto rounded-lg shadow-lg object-cover">
        </div>
